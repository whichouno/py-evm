...
def test_chain_get_ancestors_from_block_1(chain):
    ...
    block_1 = chain.mine_block().block
...
def test_chain_get_ancestors_from_block_5(chain):
    ...
    (
        ...
        block_4,
        block_5,
    ) = [chain.mine_block().block for _ in range(5)]
...
def test_chain_get_ancestors_for_fork_chains(chain, fork_chain):
    ...
    (
        ...
        block_2,
        block_3,
    ) = [chain.mine_block().block for _ in range(3)]
    (
        f_block_1,
        f_block_2,
        f_block_3,
    ) = [fork_chain.mine_block().block for _ in range(3)]
